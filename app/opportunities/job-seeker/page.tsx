...
import { getJobOpportunities, formatJobOpportunityMinimal, JobOpportunity } from '../../../lib/contentful';

// Helper Icons (optimized to prevent re-renders)
...
const AcademicCapIcon = React.memo(() => (
  <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const BuildingOfficeIcon = React.memo(() => (
  <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
// Enhanced Loading Screen with timeout and retry
...
> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    console.error('Jobs page error:', error, errorInfo);
  }
        ...
        <div className="min-h-screen bg-gray-50 dark:bg-black flex items-center justify-center px-4">
          <div className="text-center max-w-md">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              We encountered an error while loading job opportunities. Please try again.
            </p>
            <button
              onClick={() => {
...
export default function JobSeekerPage() {
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-black flex items-center justify-center px-4">
        <div className="text-center max-w-md">
          <div className="text-6xl mb-4">🔄</div>
          <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Connection Error</h3>
  ...
  if (isLoading) {
    return <LoadingScreen isTimeout={isTimeout} onRetry={isTimeout ? handleRetry : undefined} />;
  }

  return (
    <JobsErrorBoundary onRetry={handleRetry}>
