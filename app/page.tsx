...
export default function SkillDashHome() {
  ...
  return (
    <div className="w-full bg-white dark:bg-black overflow-x-hidden">
        ...
        <section className="text-center mb-24 sm:mb-32">
          ...
          <div className="my-10">
            <a href="/discover" className="inline-flex flex-col items-center bg-gradient-to-r from-blue-600 via-purple-500 to-indigo-600 text-white py-4 px-16 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 focus:outline-none active:scale-100">
              <span className="text-2xl font-bold tracking-wide">Start Your Skill Quest</span>
      ...
      <section id="learn-skills" className="min-h-screen flex items-center justify-center p-6 sm:p-12 scroll-mt-20 bg-gradient-to-br from-purple-500 to-violet-600">
          <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-center md:text-left">
                  ...
                  <a href="https://www.grameenphone.academy/" target="_blank" rel="noopener noreferrer" className="inline-block bg-white text-purple-700 font-bold py-3 px-8 rounded-lg hover:bg-purple-50 transition-all transform hover:scale-105 shadow-md">
                      Explore Courses
                  </a>
              </div>
          </div>
      ...
      <section id="resume-feedback" className="min-h-screen flex items-center justify-center p-6 sm:p-12 scroll-mt-20 bg-gradient-to-br from-sky-500 to-cyan-600">
          <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
      ...
      <section id="find-opportunities" className="min-h-screen flex items-center justify-center p-6 sm:p-12 scroll-mt-20 bg-gradient-to-br from-emerald-500 to-teal-600">
          <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div className="flex justify-center">
          ...
          <div className="max-w-5xl mx-auto px-4 pb-6 flex flex-col md:flex-row gap-6 md:gap-12 items-start justify-between">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-6 flex-1">
              ...
              <div>
                ...
                <ul className="flex flex-col gap-1 text-gray-500 dark:text-gray-400 text-sm">
                  <li><a href="/discover">Skill Quest</a></li>
